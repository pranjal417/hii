...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-gradient-to-b from-orange-50 to-white">
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-12 text-white">
            ...
            <button
              ...
              className="bg-white text-orange-600 px-8 py-4 rounded-full font-bold hover:bg-gray-50 transition-all duration-200 shadow-lg hover:scale-105"
            >
              Start Free Trial
            </button>
          </div>
