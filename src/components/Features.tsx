  ...
  return (
    <section id="features" className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 bg-gradient-to-r from-orange-500 to-red-600 rounded-3xl p-12 text-center text-white">
          ...
          <button
            ...
            className="bg-white text-orange-600 px-8 py-4 rounded-full font-bold hover:bg-gray-50 transition-colors duration-200 shadow-lg"
          >
