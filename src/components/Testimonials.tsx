...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-b from-orange-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-3xl p-12">
            ...
            <button
              onClick={openModal}
              className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-8 py-4 rounded-full font-bold hover:from-orange-600 hover:to-red-700 transition-all duration-200 shadow-lg hover:scale-105"
            >
