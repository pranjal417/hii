...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-24 bg-gradient-to-b from-white to-orange-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white hover:bg-orange-50 transition-colors duration-200 rounded-2xl border border-gray-200 hover:border-orange-300 shadow-sm hover:shadow-md"
            >
              <button
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-orange-600 to-red-700 rounded-3xl p-12 text-white">
            ...
            <button
              ...
              className="bg-white text-orange-600 px-8 py-4 rounded-full font-bold hover:bg-gray-50 transition-colors duration-200 shadow-lg hover:scale-105"
            >
